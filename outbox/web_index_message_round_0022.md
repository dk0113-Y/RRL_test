...
After the docs, read `CURRENT_ROUND.json`, then `rounds/round_0022/index_manifest.json`, then the structured round files (`metric_snapshot.json`, `benchmark_summary.json`, `config_snapshot.json`, `artifact_index.json`, `historical_baseline_summary.json`, `comparability_report.json`, `round_summary.json`).
