# New Automation Round: round_0001
...
- Branch: main
- Target Round: round_0001

**Instructions:**
1. Read `CURRENT_ROUND.json` for the high-level task and entry points.
2. Follow the manifest at `rounds/round_0001/index_manifest.json` to access relevant reports and logs.
